...
-- 2023-06-10,TommyConfar,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TommyConfar')
	 Begin 
	  Alter Database [Assignment07DB_TommyConfar] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TommyConfar;
	 End
	Create Database Assignment07DB_TommyConfar;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TommyConfar;
...
AS
select top 1000000  -- use with view create to allow order by (not 100 percent)
c.categoryname
,[inventorydate] = datename(mm, i.inventorydate) + ',' + datename(yy, I.inventorydate)
